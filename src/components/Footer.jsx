...
function Footer() {
  ...
  return (
    <div className="w-full h-screen p-20 flex gap-5 bg-zinc-50">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div>
          <h1 className="text-[5vw]  font-semibold uppercase -mb-7"> EYE-</h1>
          <h1 className="text-[5vw]  font-semibold uppercase leading-none -mb-7">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw]  font-semibold uppercase -mb-7">
          Presentations
